...
const STATE_RESOURCES = {
  TX: {
    ...
    portalName: 'SquareMeals — TDA\'s online claims system',
    ...
    deadlines: [
      ...
      { label: 'Annual Sponsor Renewal', value: 'May 31 each year', note: 'Sponsor agreement renewed via SquareMeals' },
      { label: 'Site Reviews', value: 'Every 3 years minimum', note: 'TDA schedules; 10 days to respond if contacted' },
      { label: 'Annual Training', value: 'Required annually', note: 'TDA requires sponsor staff to complete CACFP training each year' },
    ],
    requiredForms: [
    ...
    tips: [
      'SquareMeals is TDA\'s online system for all claims, site applications, and sponsor renewals — all submissions go here.',
  ...
  CA: {
    ...
    agency: 'California Dept. of Education (CDE) — Child Nutrition',
    portal: 'https://www.cde.ca.gov/ls/nu/cn/cacfp.asp',
    portalName: 'CNIPS — Child Nutrition Information and Payment System',
    phone: '916-323-1135',
    email: 'cacfp@cde.ca.gov',
    deadlines: [
      { label: 'Monthly Claim Deadline', value: '60 days after month end', note: 'Standard USDA deadline applies' },
      { label: 'Annual Renewal', value: 'Varies by sponsor approval date', note: 'Check your renewal date in CNIPS' },
      { label: 'Annual Training', value: 'Required annually', note: 'CDE requires annual training for sponsor staff' },
    ],
    requiredForms: [
      { name: 'CACFP Sponsor Application', note: 'Annual renewal via CNIPS' },
      { name: 'Site Application', note: 'Required for each site — submitted through CNIPS' },
      { name: 'Monthly Claim', note: 'Submitted via CNIPS within 60 days of month end' },
      { name: 'Income Eligibility Statement', note: 'For Tier I/II household determination' },
      { name: 'Meal Count Records', note: 'Daily records per site — retain 3 years' },
    ],
    tips: [
      'CNIPS (Child Nutrition Information and Payment System) is the CDE\'s online portal for all CACFP claims and applications.',
      'Family day care home sponsors are administered by CDSS (Dept. of Social Services), not CDE — check which agency oversees your program type.',
      'California requires Spanish-language versions of key parent forms in many counties.',
      'Contact your assigned CDE nutrition consultant for state-specific guidance and training.',
    ],
  },
  OH: {
    name: 'Ohio', flag: '🌻',
    agency: 'Ohio Dept. of Education and Workforce (DEW)',
    portal: 'https://education.ohio.gov/Topics/Student-Supports/Food-and-Nutrition/Child-and-Adult-Care-Food-Program-CACFP',
    portalName: 'CRRS — Claims Reimbursement and Reporting System',
    phone: '614-466-2945',
    email: null,
    deadlines: [
      { label: 'Monthly Claim Deadline', value: '60 days after month end', note: 'Standard USDA deadline applies' },
      { label: 'Annual Renewal', value: 'Varies', note: 'Contact your DEW representative for your renewal date' },
      { label: 'Annual Training', value: 'Required annually', note: 'DEW requires annual CACFP training for sponsor staff' },
    ],
    requiredForms: [
      { name: 'Sponsor Agreement', note: 'Annual renewal with DEW' },
      { name: 'Site Information Form', note: 'Required for each participating site' },
      { name: 'Monthly Claim for Reimbursement', note: 'Submitted via CRRS within 60 days' },
      { name: 'Income Eligibility Forms', note: 'For household Tier determination' },
      { name: 'OHID User Profile', note: 'Required for CRRS access — must be set up before submitting claims' },
    ],
    tips: [
      'Ohio uses CRRS (Claims Reimbursement and Reporting System) for all claim submissions — paper claims are not accepted.',
      'Sponsors must have an active OHID (Ohio Identity) account and User Profile to access CRRS. Set this up before your first claim.',
      'The agency was renamed from ODE to DEW (Dept. of Education and Workforce) — use DEW in all correspondence and applications.',
      'Contact your assigned DEW representative for your specific annual renewal date and required training schedule.',
    ],
  },
  VA: {
    name: 'Virginia', flag: '🦅',
    agency: 'Virginia Dept. of Education (VDOE) — Child Nutrition Programs',
    portal: 'https://www.doe.virginia.gov/programs-services/child-nutrition/cacfp',
    portalName: 'VDOE Child Nutrition Programs Portal',
    phone: '804-225-2074',
    email: 'NutritionPrograms@doe.virginia.gov',
    deadlines: [
      { label: 'Monthly Claim Deadline', value: '60 days after month end', note: 'Standard USDA deadline applies' },
      { label: 'Annual Renewal', value: 'Varies', note: 'Contact your VDOE nutrition specialist for your renewal date' },
      { label: 'Annual Training', value: 'Required annually', note: 'Virginia requires annual training for all sponsor staff' },
      { label: 'Site Reviews', value: 'Every 3 years minimum', note: 'VDOE conducts on-site administrative reviews' },
    ],
    requiredForms: [
      ...
      { name: 'Procurement Plan', note: 'Required for sponsors that purchase food — documents competitive purchasing' },
    ],
    tips: [
      'Virginia processes all CACFP claims through VDOE Child Nutrition Programs — contact your assigned specialist for submission details.',
      'Annual training is required for sponsor staff — failing to attend can trigger a management problem flag with VDOE.',
      'Sponsors that purchase food for their sites must maintain a written Procurement Plan documenting competitive purchasing practices.',
      'Virginia requires sponsors to retain all program records (meal counts, menus, income certs) for 3 years from the date of submission.',
    ],
  },
  CO: {
    name: 'Colorado', flag: '🏔️',
    agency: 'Colorado Dept. of Human Services (CDHS) — Office of Children, Youth & Families',
    portal: 'https://cdhs.colorado.gov/cacfp',
    portalName: 'CDHS CACFP Portal',
    phone: '303-866-5700',
    email: null,
    deadlines: [
      { label: 'Monthly Claim Deadline', value: '60 days after month end', note: 'Standard USDA deadline applies' },
      { label: 'Annual Renewal', value: 'Varies', note: 'Contact CDHS for your specific renewal date' },
      { label: 'Annual Training', value: 'Required annually', note: 'CDHS requires annual training for sponsor staff' },
      { label: 'Site Reviews', value: 'Every 3 years minimum', note: 'CDHS conducts on-site administrative reviews' },
    ],
    requiredForms: [
      { name: 'Sponsor Agreement', note: 'Annual renewal with CDHS' },
      { name: 'Site Participation Agreement', note: 'Required for each participating site' },
      { name: 'Monthly Claim', note: 'Submitted to CDHS within 60 days' },
      { name: 'Income Eligibility Forms', note: 'For Tier determination — retain 3 years' },
      { name: 'Meal Count / Attendance Records', note: 'Daily records per site — retain 3 years' },
    ],
    tips: [
      'Colorado CACFP is administered by CDHS Office of Children, Youth & Families — contact them for all program questions.',
      'Annual training is required for all sponsor staff — check cdhs.colorado.gov for the current training calendar.',
      'CDHS conducts on-site administrative reviews at least every 3 years — keep all records organized and accessible.',
      'Sponsors must retain all CACFP records (claims, menus, income certs, meal counts) for at least 3 years from submission.',
    ],
  },
};
