...
const { getClaim, getIntelligence, getClaimHistory, getStates } = require('../controllers/claimsController');
...
router.get('/intelligence', getIntelligence); // GET /claims/intelligence?month=2026-07
