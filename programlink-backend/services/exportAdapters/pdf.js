...
function render(claimData, res) {
  ...
  // Footer — positioned right after content, no blank pages
  y += 24;
  hr(doc, y);
  doc.fillColor(GRAY).fontSize(8).font('Helvetica')
     ...
     .text(
       'This document is an estimate. Actual reimbursement may vary based on state agency review.',
       MARGIN, y + 20, { width: CONTENT_W, align: 'center' }
     );
  doc.end();
}
